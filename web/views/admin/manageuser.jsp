                ...
                <div class="col-12">
                    <div class="card mb-4 h-100">
                        <div class="card-header justify-content-between align-items-center d-flex">
                            ...
                            <form id="filterForm" class="d-flex" action="${pageContext.request.contextPath}/searchAccount" method="get">
                                ...
                                <select name="role" class="form-control form-control-sm ms-2" style="width: 150px;" onchange="submitForm()">
                        ...
                        <ul class="list-unstyled mb-6">
                            ...
                            <li class="menu-item">
                                ...
                                <div class="collapse" id="collapseMenuItemFilms">
                                    <ul class="submenu">
                                        <li>
                                        <li><a href="/CineBooking/movie">Film Listing</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                                ...
                                <div class="collapse" id="collapseMenuItemConcessions">
                                    <ul class="submenu">
                                        <li><a href="/CineBooking/admin/concession">Concessions Listing</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                                ...
                                <div class="collapse" id="collapseMenuItemUsers">
                                    <ul class="submenu">
                                        <li style="primary" class="blue-text">User Listing</li>
                                    </ul>
                                </div>
                            </li>
