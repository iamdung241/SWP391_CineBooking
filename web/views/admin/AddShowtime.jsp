...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            function formTrue() {
                var checkRoom = validateRoom();
                if (!checkRoom) {
                    var err = document.getElementById("roomErr");
                    err.textContent = "Please choose a cinema room";
                } else {
                    err.textContent = "";
                }
                var showtime = validateShowtime();
                var movie = validateMovie();
                var date = validateDate();
                return (showtime && movie && checkRoom && date);
            }
        </script>
    </head>
    <body class="">
