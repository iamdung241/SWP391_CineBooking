...
<body>
    ...
    <jsp:include page="excelGuide.jsp"></jsp:include>
    <section class="container-fluid">
        <div class="col-12">
            <div class="card mb-4 h-100">
                ...
                %>
                <input type="hidden" id="theaterID" value="<%= theaterID %>">
                <div class="card-header justify-content-between align-items-center d-flex">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#excelGuideModal">Excel Guide</button>
                    </div>
    ...
    <script>
        ...
        function addUser(addButton) {
            ...
            let theaterID = document.getElementById('theaterID').value;
