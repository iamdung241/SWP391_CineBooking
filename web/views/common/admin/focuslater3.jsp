<%-- 
    Document   : focuslater3
    Created on : 18 May 2024, 10:56:45
    Author     : Son
--%>
                            ...
                            <div class="card mb-4 h-100">
                                ...
                                <div class="card-body">
                                    <table class="table m-0">
                                        <tbody>
                                            <tr>
                                                <td class="ps-0">
                                        <picture>
                                            <img class="f-w-12 rounded" src="${pageContext.request.contextPath}/./assets/images/logos/logo-13.svg"
                                    ...
                                    <tr>
                                        <td class="ps-0">
                                    <picture>
                                        <img class="f-w-12 rounded" src="${pageContext.request.contextPath}/./assets/images/logos/logo-15.svg"
                                             alt="HTML Bootstrap Admin Template by Pixel Rocket">
                                    </picture>
                                    </td>
                                    <td class="d-none d-xl-table-cell">
                                    ...
                                    <tr>
                                        <td class="ps-0">
                                    <picture>
                                        <img class="f-w-12 rounded" src="${pageContext.request.contextPath}/./assets/images/logos/logo-14.svg"
                                             alt="HTML Bootstrap Admin Template by Pixel Rocket">
                                    </picture>
                                    </td>
                                    <td class="d-none d-xl-table-cell">
