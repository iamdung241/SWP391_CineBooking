                    ...
                    <div class="row g-2 pb-3">
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-1.svg" alt="">
                              </picture>
                            </span>
                        ...
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-2.svg" alt="">
                              </picture>
                            </span>
                        ...
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-3.svg" alt="">
                              </picture>
                            </span>
                        ...
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-4.svg" alt="">
                              </picture>
                            </span>
                        ...
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-5.svg" alt="">
                              </picture>
                            </span>
                        ...
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-6.svg" alt="">
                              </picture>
                            </span>
                        ...
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-7.svg" alt="">
                              </picture>
                            </span>
                        ...
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-8.svg" alt="">
                              </picture>
                            </span>
                        ...
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-9.svg" alt="">
                              </picture>
                            </span>
                        ...
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-10.svg" alt="">
                              </picture>
                            </span>
                        ...
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-11.svg" alt="">
                              </picture>
                            </span>
                        ...
                        <div class="col-4 h-100">
                          <a href="#" class="d-flex justify-content-center align-items-center flex-column bg-light-hover rounded-2 px-2 py-3 transition-all">
                            <span class="d-block f-h-8">
                              <picture>
                                <img class="h-100" src="${pageContext.request.contextPath}/./assets/images/logos/logo-12.svg" alt="">
                              </picture>
                            </span>
