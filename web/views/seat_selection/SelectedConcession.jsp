...
<html lang="en">
    ...
    <body>
        <div style="background: black;padding: 0;margin: 0">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5>Movie: ${show.movie_id}</h5>
                            <h5>Date: ${show.date} | ${show.showtiming}:00</h5>
                            <h5>Room: ${show.room_id}</h5>
                            ...
                            <button id="payButton" class="btn btn-primary"><i class="fas fa-credit-card"></i> Pay</button>
                        </div>
                    </div>
                </div>
            </div>
